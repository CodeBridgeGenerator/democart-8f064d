...
const input-numberQuantityTemplate2 = (rowData, { rowIndex }) => <p >{rowData.quantity}</p>
const calendarTimestampTemplate3 = (rowData, { rowIndex }) => <p>{moment(rowData.timestamp).fromNow()}</p>
...
<Column field="quantity" header="Quantity" body={input-numberQuantityTemplate2} filter={selectedFilterFields.includes("quantity")} hidden={selectedHideFields?.includes("quantity")}  sortable  style={{ minWidth: "8rem" }} />
<Column field="timestamp" header="Timestamp Order History After Checkout" body={calendarTimestampTemplate3} filter={selectedFilterFields.includes("timestamp")} hidden={selectedHideFields?.includes("timestamp")}  sortable  style={{ minWidth: "8rem" }} />

...
<Column field="quantity" header="Quantity Current Cart Pre Checkout" body={input-numberQuantityTemplate2} filter={selectedFilterFields.includes("quantity")} hidden={selectedHideFields?.includes("quantity")}  sortable  style={{ minWidth: "8rem" }} />

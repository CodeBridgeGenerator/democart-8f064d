...
const input-textNameTemplate0 = (rowData, { rowIndex }) => <p >{rowData.name}</p>
  ...
  const handleHideDialog = () => {
    ...
    return (
        ...
        />
<Column field="name" header="Name" body={input-textNameTemplate0} filter={selectedFilterFields.includes("name")} hidden={selectedHideFields?.includes("name")}  sortable  style={{ minWidth: "8rem" }} />
